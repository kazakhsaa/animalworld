...
// canv for the moving PolyPiece and the full image
  ...
  if (!this.menu) {
    this.menu = new Menu({
      ...
      lineStep: 30,
      lines: [
        {text: "Сурет", func: this.loadImage()},
        {text: "12 дана", func: this.returnFunct(12)},
        {text: "25 дана", func: this.returnFunct(25)},
        {text: "50 дана", func: this.returnFunct(50)},
        {text: "100 дана", func: this.returnFunct(100)}
      ]
    });
  }
  if (autoStart) {
